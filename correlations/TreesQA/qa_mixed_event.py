...
input_file = TFile.Open("/home/mdicosta/DFlowOO/Correlations/20100_ME/AnalysisResults.root", "READ")
...
outfile = TFile.Open("/home/mdicosta/DFlowOO/Correlations/20100_ME/MixedEventQA.root", "RECREATE")
...
for key, histo in delta_eta_histos.items():
    ...
    print(f"Histo integral before normalization: {histo.Integral()}")
    if histo.Integral() > 0:
